...
<div class="logo">
	<a href="index.php">
		...
		<h2 style="color: black;">Online Store</h2>
...
<div class="search-area">
    <form name="search" method="post" action="search-result.php">
        <div class="control-group">
            ...
            <input class="search-field" placeholder="Search products" name="product" required="required" />
		...
		<a href="#" class="dropdown-toggle lnk-cart" data-toggle="dropdown">
			<div class="items-cart-inner">
				<div class="total-price-basket">
					...
					<span class="total-price" style="color: black;">
				...
				<div class="basket-item-count" style="color: black;"><span class="count"><?php echo $_SESSION['qnty'];?></span></div>
