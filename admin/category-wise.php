...
<head>
	...
	<title>Admin|Category sort</title>
...
<?php @ $query=mysqli_query($con,"SELECT * FROM products WHERE category=$category AND subcategory= $subcat");
@$cnt=1;
while(@$row=mysqli_fetch_array($query))
{
?>									
						...
						<h1> Total Products:<?php echo $cnt-1; ?> </h1>
