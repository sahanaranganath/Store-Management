...
<?php } ?>
						...
						<ul class="widget widget-menu unstyled">
						<li><a href="report.php"><i class="menu-icon icon-tasks"></i>Order report </a></li>
						<li><a href="productlogdetails.php"><i class="menu-icon icon-tasks"></i>Product log </a></li>
