...
$sql=mysqli_query($con,"update  products set category='$category',quantity='$quantity',subCategory='$subcat',productName='$productname',productCompany='$productcompany',productPrice='$productprice',productDescription='$productdescription',shippingCharge='$productscharge',productAvailability='$productavailability',productPriceBeforeDiscount='$productpricebd' where id='$pid' ");
...
<div class="controls">
<input type="text"    name="quantity"  placeholder="Enter availabilty" value="<?php echo htmlentities($row['quantity']);?>" class="span8 tip" required>
</div>
</div>
