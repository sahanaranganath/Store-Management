              ...
              if($res_sp = mysqli_query($data,$sql_sp)) {
                while($row_sp = mysqli_fetch_row($res_sp)){
                  ...
                  echo "<tr>";
                        ...
                        echo "<td>";
                        echo "<p> CHAIRS: " ;echo $row_sp["11"]."</p>" ;
                        echo "<p> TABLES: " ;echo $row_sp["12"]."</p>" ;
                        echo "<p> LIGHTS: " ;echo $row_sp["13"]."</p>" ;
                        echo "<p> SPEAKERS: " ;echo $row_sp["14"]."</p>" ;
                        echo "<p> MICROPHONES: " ;echo $row_sp["15"]."</p>" ;
                        echo" </td>";
